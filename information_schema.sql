...
--
-- 替换视图以便查看 `INNODB_SYS_SEMAPHORE_WAITS`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_TABLESPACES_ENCRYPTION`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_TABLESPACES_SCRUBBING`
-- （参见下面的实际视图）
--
...
--
-- 视图结构 `INNODB_SYS_SEMAPHORE_WAITS`
--
...
--
-- 视图结构 `INNODB_TABLESPACES_ENCRYPTION`
--
...
--
-- 视图结构 `INNODB_TABLESPACES_SCRUBBING`
--
